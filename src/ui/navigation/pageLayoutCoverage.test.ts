...
const expectedAssets = [
  ...
  'EventsPageLayout.asset',
  'EventDetailPageLayout.asset',
  'TournamentsPageLayout.asset',
  'TournamentDetailPageLayout.asset',
  'LeaderboardPageLayout.asset',
  'MatchesPageLayout.asset',
  'MatchDetailPageLayout.asset',
...
const expectedRouteCoverage = {
  ...
  [PublicRoutePath[PublicRouteKey.Events]]: 'EventsPageLayout.asset',
  [PublicRoutePath[PublicRouteKey.EventDetail]]: 'EventDetailPageLayout.asset',
  ...
  [PublicRoutePath[PublicRouteKey.Matches]]: 'MatchesPageLayout.asset',
  [PublicRoutePath[PublicRouteKey.MatchDetail]]: 'MatchDetailPageLayout.asset',
