...
export default function CenterTableSVG(props: CenterTableSVGProps) {
  ...
  const viewportWidth =
    platformUI?.viewportWidth ?? (typeof window === 'undefined' ? width : window.innerWidth || document.documentElement.clientWidth);
  const viewportHeight =
    platformUI?.viewportHeight ?? (typeof window === 'undefined' ? height : window.innerHeight || document.documentElement.clientHeight);
  const scale = useMemo(() => {
  ...
  }, [height, maxScale, minScale, responsivePaddingX, responsivePaddingY, viewportHeight, viewportWidth, width]);
    ...
    <div className={p.containerClassName || undefined} style={containerStyle} role="presentation">
      ...
      >
        ...
        <rect
          ...
          className={p.rimGlowBlendMode && p.rimGlowBlendMode !== 'screen' ? undefined : 'center-table-svg__rim-glow'}
          style={p.rimGlowBlendMode && p.rimGlowBlendMode !== 'screen' ? { mixBlendMode: p.rimGlowBlendMode } : undefined}
          filter="url(#rimGlow)"
        />
        ...
        <rect
          ...
          strokeLinejoin="round"
          strokeLinecap="round"
          className="center-table-svg__inner-rim"
        ...
        <rect
          ...
          strokeLinejoin="round"
          strokeLinecap="round"
          className="center-table-svg__edge-highlight"
        />
      </svg>
    </div>
  );
