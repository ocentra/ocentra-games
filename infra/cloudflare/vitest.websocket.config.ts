...
const websocketInclude = getWebsocketIncludeFiles(__dirname);
...
export default defineWorkersConfig({
  test: {
    ...
    outputFile: {
      json: './test-runner/ReportJson/test-results-websocket.json',
      text: './test-runner/logs/test-output-websocket.txt',
    },
    onConsoleLog() {
      return true;
    },
