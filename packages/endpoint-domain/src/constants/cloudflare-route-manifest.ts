...
export const CloudflareRouteManifest: readonly RouteSpec[] = [
  ...
  { path: ApiEndpoint.AI.Keys, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.AIKeys, method: HttpMethod.Get, middleware: [MiddlewareKey.Auth], priority: 15 },
  ...
  { path: ApiEndpoint.Message.Base, match: RouteMatch.Prefix, handlerKey: CloudflareHandlerKey.Message, middleware: [MiddlewareKey.Auth], priority: 10 },
  { path: ApiEndpoint.Feed.Base, match: RouteMatch.Prefix, handlerKey: CloudflareHandlerKey.Feed, priority: 10 },
  { path: ApiEndpoint.Party.Base, match: RouteMatch.Prefix, handlerKey: CloudflareHandlerKey.Party, middleware: [MiddlewareKey.Auth], priority: 10 },
  { path: ApiEndpoint.Notification.Base, match: RouteMatch.Prefix, handlerKey: CloudflareHandlerKey.Notification, middleware: [MiddlewareKey.Auth], priority: 10 },
  ...
  {
    path: ApiEndpoint.Admin.Base,
    match: RouteMatch.Exact,
    handlerKey: CloudflareHandlerKey.Admin,
    method: HttpMethod.Get,
    middleware: [MiddlewareKey.Auth],
    priority: 10,
  },
  ...
  { path: ApiEndpoint.Admin.DashboardData, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Get, middleware: [MiddlewareKey.Auth], priority: 15 },
  { path: ApiEndpoint.Admin.ModerationQueue, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Get, middleware: [MiddlewareKey.Auth], priority: 15 },
  { path: ApiEndpoint.Admin.ModerationReport, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Post, middleware: [MiddlewareKey.Auth], priority: 15 },
   { path: `${ApiEndpoint.Admin.Base}/moderation`, match: RouteMatch.PrefixAndIncludes, includes: '/resolve' as PathSegment, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Post, middleware: [MiddlewareKey.Auth], priority: 15 },
   { path: `${ApiEndpoint.Admin.Base}/users`, match: RouteMatch.PrefixAndIncludes, includes: '/status' as PathSegment, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Post, middleware: [MiddlewareKey.Auth], priority: 15 },
  { path: ApiEndpoint.Admin.CreditsPlan, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Post, middleware: [MiddlewareKey.Auth], priority: 15 },
  { path: ApiEndpoint.Admin.AICatalog, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Patch, middleware: [MiddlewareKey.Auth], priority: 15 },
  { path: ApiEndpoint.Admin.TransparencyDashboard, match: RouteMatch.Exact, handlerKey: CloudflareHandlerKey.Admin, method: HttpMethod.Get, middleware: [MiddlewareKey.Auth], priority: 15 },
  {
