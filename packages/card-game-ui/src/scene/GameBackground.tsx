...
import {
  cardGameBgImageUrl as CardBg,
  cardGameClubFilledImageUrl as CardClubFilled,
  cardGameClubHollowImageUrl as CardClubHollow,
  cardGameDiamondFilledImageUrl as CardDiamondFilled,
  cardGameDiamondHollowImageUrl as CardDiamondHollow,
  cardGameHeartFilledImageUrl as CardHeartFilled,
  cardGameHeartHollowImageUrl as CardHeartHollow,
  cardGameSpadeFilledImageUrl as CardSpadeFilled,
  cardGameSpadeHollowImageUrl as CardSpadeHollow,
  cardGameClubWithCirclesFilledImageUrl as ClubWithCirclesFilled,
  cardGameClubWithCirclesHollowImageUrl as ClubWithCirclesHollow,
  cardGameDiamondWithCirclesFilledImageUrl as DiamondWithCirclesFilled,
  cardGameDiamondWithCirclesHollowImageUrl as DiamondWithCirclesHollow,
  cardGameHeartWithCirclesFilledImageUrl as HeartWithCirclesFilled,
...
const PAIRS = [
  {
    ...
    floatDelay: '-1.2s',
    floatRotate: '0.45deg',
    filledImage: CardClubFilled,
    hollowImage: CardClubHollow,
  },
  {
    ...
    floatDelay: '-2.1s',
    floatRotate: '-0.35deg',
    filledImage: ClubWithCirclesFilled,
    hollowImage: ClubWithCirclesHollow,
  },
  {
    ...
    floatDelay: '-0.7s',
    floatRotate: '-0.4deg',
    filledImage: CardDiamondFilled,
    hollowImage: CardDiamondHollow,
  },
  {
    ...
    floatDelay: '-1.5s',
    floatRotate: '0.35deg',
    filledImage: DiamondWithCirclesFilled,
    hollowImage: DiamondWithCirclesHollow,
  },
  {
    ...
    floatDelay: '-2.7s',
    floatRotate: '-0.35deg',
    filledImage: SpadeWithCirclesFilled,
    hollowImage: SpadeWithCirclesHollow,
  },
  {
    ...
    floatDelay: '-1.8s',
    floatRotate: '0.45deg',
    filledImage: CardHeartFilled,
    hollowImage: CardHeartHollow,
  },
  {
    ...
    floatDelay: '-0.4s',
    floatRotate: '-0.32deg',
    filledImage: HeartWithCirclesFilled,
    hollowImage: HeartWithCirclesHollow,
  },
  {
    ...
    floatDelay: '-2.4s',
    floatRotate: '0.45deg',
    filledImage: CardSpadeFilled,
    hollowImage: CardSpadeHollow,
  },
] as const;
