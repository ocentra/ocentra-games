...
export const SHOP_SECTIONS: Record<ShopTab, ShopSection> = {
  ...
  'Play Access': {
    ...
    footerItems: ['Private tables', 'Public tables', 'Guest invites', 'Solana proofing', 'Room chat', 'Club rooms'],
    categories: [
      { title: 'Private Tables', subtitle: 'Invite-only rooms with host control.', tone: 'cyan', icon: 'lock', badge: 'CORE', imageUrl: shopPagePrivateTableImageUrl },
      { title: 'Public Tables', subtitle: 'Open tables visible to active players.', tone: 'green', icon: 'cards', imageUrl: shopPagePublicTableImageUrl },
      { title: 'Guest Invites', subtitle: 'Shareable links for quick table entry.', tone: 'orange', icon: 'link', imageUrl: shopPageInviteFriendImageUrl },
      { title: 'Solana Backed', subtitle: 'Optional chain-backed proof surfaces.', tone: 'violet', icon: 'shield', imageUrl: solanaImageUrl },
      { title: 'Room Chat', subtitle: 'Table-side messages for room context.', tone: 'silver', icon: 'crate', imageUrl: shopPageRoomChatImageUrl },
      { title: 'Club Rooms', subtitle: 'Persistent spaces for trusted groups.', tone: 'gold', icon: 'crown', imageUrl: '' },
    ],
    featured: [
      { title: 'Private Table', subtitle: 'Create protected rooms, set rules, invite players, and keep control of the table.', tone: 'cyan', icon: 'lock', badge: 'HOST', imageUrl: shopPagePrivateTableImageUrl },
      { title: 'Public Table', subtitle: 'Let players find open tables and jump into active play without a private link.', tone: 'green', icon: 'cards', badge: 'OPEN', imageUrl: shopPagePublicTableImageUrl },
      { title: 'Guest Invite', subtitle: 'Bring guests into a room with a shareable invite and clear entry state.', tone: 'orange', icon: 'link', imageUrl: shopPageInviteFriendImageUrl },
      { title: 'Solana Backed', subtitle: 'Show chain-backed verification where a room or event needs stronger trust.', tone: 'violet', icon: 'shield', imageUrl: solanaImageUrl },
      { title: 'Room Chat', subtitle: 'Keep table messages tied to the current room, players, and match flow.', tone: 'silver', icon: 'crate', imageUrl: shopPageRoomChatImageUrl },
      { title: 'Club Rooms', subtitle: 'Persistent spaces for groups, friends, recurring tables, and private communities.', tone: 'gold', icon: 'crown', imageUrl: '' },
    ],
  },
  Events: {
    title: 'EVENTS',
...
export const SHOP_STATIC_PASSES: ShopStaticItem[] = [
  ...
  },
  {
    ...
    benefits: ['1,200 AC monthly', 'Premium table themes', 'Private rooms', 'Extra active tables (+4)', 'Saved async games (25)', 'Advanced AI analysis', 'Priority matchmaking', 'Monthly event ticket'],
  },
  {
...
export const SHOP_PREVIEWS: ShopPreviewRow[] = [
  ...
  { title: 'PLAY ACCESS PREVIEW', tab: 'Play Access', subtitle: 'Ways to host and join', items: ['Private Table', 'Public Table', 'Guest Invite', 'Solana Backed', 'Room Chat', 'Club Rooms'], accent: '#20e39d', imageUrls: SHOP_SECTIONS['Play Access'].categories?.map(item => item.imageUrl).slice(0, 6) ?? [] },
