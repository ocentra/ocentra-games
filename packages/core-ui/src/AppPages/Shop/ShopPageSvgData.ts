...
export const SHOP_VAULT_SHOWCASE_GROUPS: ShopVaultShowcaseGroup[] = [
  {
    ...
    items: [
      { title: 'Standard 52', subtitle: 'Classic French-suited deck previewed from the shared deck asset.', tone: 'gold', icon: 'cards', badge: 'DIGITAL', price: 'Digital + Printable', imageUrl: shopPageDecksImageUrl, benefits: ['Loads card faces from the deck asset.', 'Uses the shared deck preview matrix.', 'Ready for shop entitlement wiring.'] },
      { title: 'Standard 40', subtitle: 'Stripped French-suited deck for regional game modes.', tone: 'cyan', icon: 'cards', badge: 'CORE', price: 'Digital + Printable', imageUrl: shopPageDecksImageUrl, benefits: ['Uses the same card-image resolver.', 'Keeps regional decks discoverable.', 'Can become a product without UI changes.'] },
      { title: 'Standard 32', subtitle: 'Compact deck used by shorter ranking cycles and variants.', tone: 'violet', icon: 'cards', badge: 'CORE', price: 'Digital + Printable', imageUrl: shopPageDecksImageUrl, benefits: ['Preview comes from authored deck data.', 'Shows high cards in the Vault fan.', 'Expands into the shared deck matrix.'] },
      { title: 'Tarot 78', subtitle: 'Tarot deck preview with trump cards surfaced first.', tone: 'orange', icon: 'cards', badge: 'TRUMPS', price: 'Digital + Printable', imageUrl: shopPageDecksImageUrl, benefits: ['Prioritizes trump previews.', 'Uses the same detail expansion behavior.', 'Fits seasonal or event releases.'] },
      { title: 'Hanafuda 48', subtitle: 'Flower-card deck preview backed by the Hanafuda deck asset.', tone: 'silver', icon: 'cards', badge: 'SPECIAL', price: 'Digital + Printable', imageUrl: shopPageDecksImageUrl, benefits: ['Supports non-French deck families.', 'Reuses shared asset loading.', 'Prepared for collection and inventory flow.'] },
    ],
  },
  {
    key: 'card-backs',
...
export const SHOP_UI_COPY = {
  ...
  earnRewards: {
    ...
    shareTargetStatus: 'Share Target',
  ...
  actions: {
    ...
    openVaultGroup: 'Open Vault Group',
    working: 'Working',
    details: 'Details',
    backToShop: 'Back To Shop',
    backToPrefix: 'Back To',
    vaultEntryCountSuffix: 'vault entries',
    selectVaultGroup: 'Select to preview group',
  },
  payment: {
    titlePrefix: 'Pay for',
    defaultDescription: 'Choose a checkout provider to start this purchase.',
    ...
    select: 'Select',
    cancel: 'Cancel',
    signInRequired: 'Sign in is required before checkout.',
    successAccepted: 'Purchase request accepted.',
    providerNotConfigured: 'Checkout provider is not configured yet.',
    checkoutFailed: 'Checkout request failed.',
  },
  deckPreview: {
    title: 'DECK PREVIEW',
    backToVault: 'Back To Vault',
    digitalDeck: 'Digital Deck',
    purchaseOptionsSuffix: 'purchase options',
    printableDigital: 'Printable + Digital',
    includedStarterDeck: 'Included starter deck.',
    tableReadyDigitalDeck: 'Table-ready digital deck.',
    printableExportIncluded: 'Printable export included.',
    cardArtworkIncluded: 'Card artwork included when available.',
    noDeckData: 'No deck data available.',
    cardBackAlt: 'Back',
    cardBackLabel: 'Back',
