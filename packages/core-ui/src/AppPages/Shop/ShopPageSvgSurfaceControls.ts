...
export const DEFAULT_SHOP_PAGE_SVG_CONTROLS: ShopPageSvgControls = {
  ...
  mainBody: {
    ...
    bottomRowInnerPad: 22,
    treasuryCardMinW: 150,
    treasuryCardMaxW: 228,
  ...
  componentTokens: {
    headerLayer: {
      ...
      balancePanelGlowStrokeWidth: 4,
      balancePanelGlowOpacity: 0.16,
      balanceCoinX: 10,
      balanceCoinY: 21,
      balanceCoinSize: 48,
      balanceDividerX: 66,
    ...
    glassEffects: {
      glowDx: 0,
      glowDy: 0,
      glowStdDeviation: 3.2,
      glowOpacity: 0.22,
      shadowDx: 0,
      shadowDy: 10,
      shadowStdDeviation: 12,
      shadowOpacity: 0.32,
      cyanGlowStdDeviation: 3.4,
    },
    cardChrome: {
      radius: 0,
...
const SHOP_PAGE_SVG_CURATED_NUMBER_FIELDS: Record<ShopPageSvgNumberControlGroup, ShopPageSvgNumberField[]> = {
  ...
  mainBody: [
    ...
    { group: 'mainBody', key: 'treasuryCardMinW', label: 'Credit Min Card W', min: 96, max: 220 },
    { group: 'mainBody', key: 'treasuryCardMaxW', label: 'Credit Max Card W', min: 140, max: 320 },
    { group: 'mainBody', key: 'treasuryMaxVisible', label: 'Credit Max Visible', min: 1, max: 7, step: 1 },
    { group: 'mainBody', key: 'passCardMinW', label: 'Pass Min Card W', min: 140, max: 320 },
    { group: 'mainBody', key: 'passCardMaxW', label: 'Pass Max Card W', min: 170, max: 380 },
    { group: 'mainBody', key: 'passMaxVisible', label: 'Pass Max Visible', min: 1, max: 5, step: 1 },
    { group: 'mainBody', key: 'productCardMinW', label: 'Product Min Card W', min: 120, max: 300 },
    { group: 'mainBody', key: 'productCardMaxW', label: 'Product Max Card W', min: 150, max: 360 },
