...
export const LEADERBOARD_PAGE_SVG_NUMBER_FIELDS: LeaderboardPageSvgNumberField[] = [
  ...
  { group: 'layout', key: 'mainY', label: 'Main Y', min: 96, max: 210, step: 1 },
...
export function normalizeLeaderboardPageSvgControls(
  ...
  return {
    ...
    layout: {
      ...
      mainY: clampNumber(controls?.layout?.mainY, 96, 210, DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.layout.mainY),
