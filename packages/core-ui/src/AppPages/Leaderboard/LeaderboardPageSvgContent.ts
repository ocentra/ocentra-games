...
export const DEFAULT_LEADERBOARD_PAGE_CONTENT: LeaderboardPageContentData = {
  ...
  topGames: [
    { id: 'three-card-brag', rank: 1, name: 'Three Card Brag', matches: '894K', growth: '+18.2%', tone: 'gold', category: 'Vying', subcategory: 'Comparing / Three-card', gameType: 1, routePath: '/leaderboard' },
    { id: 'spades', rank: 2, name: 'Spades', matches: '612K', growth: '+11.3%', tone: 'cyan', category: 'Trick-taking', subcategory: 'Point-trick / Bidding', gameType: 3, routePath: '/leaderboard' },
    { id: 'poker', rank: 3, name: 'Poker', matches: '538K', growth: '+9.7%', tone: 'red', category: 'Poker', subcategory: 'Vying / Betting', gameType: 4, routePath: '/leaderboard' },
    { id: 'rummy', rank: 4, name: 'Rummy', matches: '456K', growth: '+7.8%', tone: 'purple', category: 'Rummy', subcategory: 'Matching / Sets and runs', gameType: 5, routePath: '/leaderboard' },
    { id: 'blackjack', rank: 5, name: 'Blackjack', matches: '312K', growth: '+5.4%', tone: 'muted', category: 'Banking', subcategory: 'Casino / Hand total', gameType: 6, routePath: '/leaderboard' },
  ],
  quickGames: [
    { id: 'three-card-brag', name: 'THREE CARD BRAG', detail: 'Vying ladder', icon: 'crown', tone: 'gold', category: 'Vying', subcategory: 'Comparing / Three-card', gameType: 1, routePath: '/leaderboard' },
    { id: 'spades', name: 'SPADES', detail: 'Trick-taking ladder', icon: 'shield', tone: 'purple', category: 'Trick-taking', subcategory: 'Point-trick / Bidding', gameType: 3, routePath: '/leaderboard' },
    { id: 'poker', name: 'POKER', detail: 'Poker ladder', icon: 'circle', tone: 'red', category: 'Poker', subcategory: 'Vying / Betting', gameType: 4, routePath: '/leaderboard' },
    { id: 'rummy', name: 'RUMMY', detail: 'Rummy ladder', icon: 'swords', tone: 'cyan', category: 'Rummy', subcategory: 'Matching / Sets and runs', gameType: 5, routePath: '/leaderboard' },
    { id: 'blackjack', name: 'BLACKJACK', detail: 'Banking ladder', icon: 'shield', tone: 'muted', category: 'Banking', subcategory: 'Casino / Hand total', gameType: 6, routePath: '/leaderboard' },
    { id: 'teen-patti', name: 'TEEN PATTI', detail: 'Vying ladder', icon: 'circle', tone: 'red', category: 'Vying', subcategory: 'Comparing / Three-card', gameType: 7, routePath: '/leaderboard' },
  ],
  fallbackRows: [
