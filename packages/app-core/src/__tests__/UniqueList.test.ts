...
describe('UniqueList', () => {
  let list: UniqueList<TestItem>;

  beforeEach(() => {
    list = new UniqueList<TestItem>((item) => item.id);
  });
  ...
  describe('add', () => {
    ...
    it('should replace duplicate items with same key', () => {
      const item1: TestItem = { id: '1', name: 'Test1' };
      const item2: TestItem = { id: '1', name: 'Test2' };
  ...
  describe('toArray', () => {
    it('should return array of all items', () => {
      const item1: TestItem = { id: '1', name: 'Test1' };
      const item2: TestItem = { id: '2', name: 'Test2' };
      list.add(item1);
      list.add(item2);
