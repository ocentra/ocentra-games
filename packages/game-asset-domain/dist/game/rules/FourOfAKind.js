...
let FourOfAKind = class FourOfAKind extends BaseBonusRule {
    minNumberOfCard = 4;
    bonusValue = 135;
    patternType = 'four_of_kind';
    ...
    async evaluate(hand, trumpCard) {
        ...
        const descriptions = [`Four of a Kind: ${rankName}`];
        if (this.gameMode?.useTrump && trumpCard && hand.some(c => c.id === trumpCard.id)) {
...
], FourOfAKind.prototype, "minNumberOfCard", void 0);
__decorate([
    serializable({ label: 'Default Bonus Value' }),
    __metadata("design:type", Number)
], FourOfAKind.prototype, "bonusValue", void 0);
__decorate([
    serializable({ label: 'Pattern Type' }),
    __metadata("design:type", String)
], FourOfAKind.prototype, "patternType", void 0);
__decorate([
    serializable({ label: 'Rule Name' }),
    __metadata("design:type", String)
], FourOfAKind.prototype, "ruleName", void 0);
__decorate([
    serializable({ label: 'Priority' }),
    __metadata("design:type", Number)
], FourOfAKind.prototype, "priority", void 0);
FourOfAKind = __decorate([
    serializableClass({
