...
export declare class TrumpOfAKind extends BaseBonusRule {
    ...
    createExampleHand(handSize: number, cardRanking: CardRanking, trumpCard?: Card, coloured?: boolean): string[];
