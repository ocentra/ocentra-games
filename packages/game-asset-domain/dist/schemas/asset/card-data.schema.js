...
import { ImageHashSchema } from '../../schemas/asset/shared/image-hash-schema.js';
import { ImagePathSchema } from '../../schemas/asset/shared/image-path-schema.js';
import { CardIdSchema } from '../../schemas/asset/shared/card-id-schema.js';
import { AssetResourceEntrySchema } from '../../schemas/asset/shared/brand-schemas.js';
...
const familyPrefix = (family) => family.toLowerCase().replace(/[^a-z0-9]+/g, '_').replace(/^_+|_+$/g, '');
...
export const CardDataSchema = CardDataFieldsSchema.superRefine((d, ctx) => {
