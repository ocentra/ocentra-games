...
function parseFieldTypes(classContent: string, classStartIndex: number): { fieldTypes: Record<string, string>; requiredFields: Record<string, string> } {
  ...
  const classBodyMatch = classContent.substring(classStartIndex).match(/\{([\s\S]*)\}/);
  if (!classBodyMatch) return { fieldTypes, requiredFields };
...
`;
  ...
  const assetTypeMapContent = `// This file is auto-generated by scripts/generate-registry-maps.ts
// Do not edit manually - it will be overwritten on build

import type { AssetTypeMetadata } from '@ocentra/asset-domain/constants/assets';

export const assetTypeMap: Record<string, AssetTypeMetadata> = ${JSON.stringify(assetTypeMap, null, 2)};
`;

  const loaderEntries = Object.entries(assetTypeMap)
    .filter(([, m]) => m.importPath.startsWith('@ocentra/'))
    .map(([k, m]) => {
      return `  ${JSON.stringify(k)}: () => import(${JSON.stringify(m.importPath)})`;
    })
    .join(',\n');
  const assetConstructorLoadersContent = `// This file is auto-generated by scripts/generate-registry-maps.ts
// Do not edit manually - it will be overwritten on build
...
`;
  ...
  const fieldTypeMapContent = `// This file is auto-generated by scripts/generate-registry-maps.ts
// Do not edit manually - it will be overwritten on build

export const fieldTypeMap: Record<string, Record<string, string>> = ${JSON.stringify(fieldTypeMap, null, 2)};
`;

  const requiredFieldsMapContent = `// This file is auto-generated by scripts/generate-registry-maps.ts
// Do not edit manually - it will be overwritten on build

export const requiredFieldsMap: Record<string, Record<string, string>> = ${JSON.stringify(requiredFieldsMap, null, 2)};
`;

  writeFileSync(join(registryDir, 'inspectorMap.generated.ts'), inspectorMapContent, 'utf-8');
  writeFileSync(join(registryDir, 'assetTypeMap.generated.ts'), assetTypeMapContent, 'utf-8');
  writeFileSync(join(registryDir, 'assetConstructorLoaders.generated.ts'), assetConstructorLoadersContent, 'utf-8');
  writeFileSync(join(registryDir, 'fieldTypeMap.generated.ts'), fieldTypeMapContent, 'utf-8');
  writeFileSync(join(registryDir, 'requiredFieldsMap.generated.ts'), requiredFieldsMapContent, 'utf-8');
